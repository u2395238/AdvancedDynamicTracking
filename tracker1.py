    ...
    for frame_idx, (path, img, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if show_vid:
                ...
                cv2.line(im0,(350,h-100),(w,h-100),(0,0,255),thickness=3)
                ...
                cv2.putText(im0, "Incoming Traffic:  "+str(down_count), (100,100), font, 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='input1.mp4', help='source')  # file/folder, 0 for webcam
